...
getwd()
# [1] "D:/Projects/Uber Data Analysis Using R/Uber-Data-Analysis-main"


# Read the data for each month separately 
apr <- read.csv("D:/Projects/Uber Data Analysis Using R/Uber-dataset/uber-raw-data-apr14.csv/uber-raw-data-apr14.csv")
may <- read.csv("D:/Projects/Uber Data Analysis Using R/Uber-dataset/uber-raw-data-may14.csv/uber-raw-data-may14.csv")
june <- read.csv("D:/Projects/Uber Data Analysis Using R/Uber-dataset/uber-raw-data-jun14.csv/uber-raw-data-jun14.csv")
july <- read.csv("D:/Projects/Uber Data Analysis Using R/Uber-dataset/uber-raw-data-jul14.csv/uber-raw-data-jul14.csv")
aug <- read.csv("D:/Projects/Uber Data Analysis Using R/Uber-dataset/uber-raw-data-aug14.csv/uber-raw-data-aug14.csv")
sept <- read.csv("D:/Projects/Uber Data Analysis Using R/Uber-dataset/uber-raw-data-sep14.csv/uber-raw-data-sep14.csv")
